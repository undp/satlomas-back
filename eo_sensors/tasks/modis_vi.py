...
def download_and_process(date_from, date_to):
    ...
    srtm_clipped_path = os.path.join(MODIS_VI_TASKS_DATA_DIR,
                                     'srtm_dem_clipped.tif')
    ...
    dst_name = os.path.join(MVI_MASK_DIR,
    ...
    pixelrel_clipped_path = os.path.join(MVI_CLIP_DIR,
    ...
    cloud_mask_path = os.path.join(MVI_MASK_DIR,
                                   '{}_cloud_mask.tif'.format(period_s))
...
def create_masks(period):
    ...
    src_path = os.path.join(MVI_MASK_DIR,
